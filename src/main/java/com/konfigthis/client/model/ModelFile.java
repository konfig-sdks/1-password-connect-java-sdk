...
import com.konfigthis.client.model.FileSection;
...
public class ModelFile {
  ...
  **/
  ...
  @ApiModelProperty(example = "6r65pjq33banznomn7q22sj44e", value = "ID of the file")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "foo.txt", value = "Name of the file")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "35", value = "Size in bytes of the file")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "v1/vaults/ionaiwtdvgclrixbt6ztpqcxnq/items/p7eflcy7f5mk7vg6zrzf5rjjyu/files/6r65pjq33banznomn7q22sj44e/content", value = "Path of the Connect API that can be used to download the contents of this file.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, _file.id) &&
        ...
        Arrays.equals(this.content, _file.content)&&
        Objects.equals(this.additionalProperties, _file.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, size, contentPath, section, Arrays.hashCode(content), additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("section") != null && !jsonObj.get("section").isJsonNull()) {
        FileSection.validateJsonObject(jsonObj.getAsJsonObject("section"));
      }
  }
